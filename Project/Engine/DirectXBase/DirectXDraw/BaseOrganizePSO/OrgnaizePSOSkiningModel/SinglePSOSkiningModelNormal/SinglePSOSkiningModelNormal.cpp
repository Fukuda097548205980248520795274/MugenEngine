#include "SinglePSOSkiningModelNormal.h"
...
void SinglePSOSkiningModelNormal::Initialize(LogFile* logFile, IDxcBlob* vertexShaderBlob, IDxcBlob* pixelShaderBlob,
	ID3D12Device* device, ID3D12GraphicsCommandList* commandList)
{
	...
	// PSO生成成功のログ
	logFile_->Log("SUCCEEDED : Primitive Normal PSO \n");
