#include "OrgnaizePSOSkiningModel.h"
...
void OrgnaizePSOSkiningModel::Initialize(LogFile* logFile, DirectXShaderCompile* directXShaderCompile,
	ID3D12GraphicsCommandList* commandList, ID3D12Device* device)
{
	...
	// 頂点シェーダのバイナリデータを取得する
	vertexShaderBlob_ = directXShaderCompile_->CompilerShader(L"./Resources/Shader/SkiningModel/SkiningModel.VS.hlsl", L"vs_6_0");
	...
	// PSOの生成と初期化
	pso_ = std::make_unique<SinglePSOSkiningModelNormal>();
