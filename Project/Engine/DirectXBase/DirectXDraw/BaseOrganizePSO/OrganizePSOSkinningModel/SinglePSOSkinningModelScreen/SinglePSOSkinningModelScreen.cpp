#include "SinglePSOSkinningModelScreen.h"
...
void SinglePSOSkinningModelScreen::Initialize(LogFile* logFile, IDxcBlob* vertexShaderBlob, IDxcBlob* pixelShaderBlob,
	ID3D12Device* device, ID3D12GraphicsCommandList* commandList)
{
	...
	// PSO生成成功のログ
	logFile_->Log("SUCCEEDED : SkinningModel Screen PSO \n");
