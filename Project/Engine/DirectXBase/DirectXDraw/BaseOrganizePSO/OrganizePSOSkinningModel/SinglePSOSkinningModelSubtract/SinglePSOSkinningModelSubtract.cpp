#include "SinglePSOSkinningModelSubtract.h"
...
void SinglePSOSkinningModelSubtract::Initialize(LogFile* logFile, IDxcBlob* vertexShaderBlob, IDxcBlob* pixelShaderBlob,
	ID3D12Device* device, ID3D12GraphicsCommandList* commandList)
{
	...
	descriptorRangePointLight[0].BaseShaderRegister = 2;
	descriptorRangePointLight[0].RegisterSpace = 0;
	...
	// DescriptorTable PixelShade t1 平行光源
	...
	// DescriptorTable PixelShader t2 ポイントライト
	...
	rootParameter[6].DescriptorTable.pDescriptorRanges = descriptorRangePointLight;
	rootParameter[6].DescriptorTable.NumDescriptorRanges = _countof(descriptorRangePointLight);

	// CBV PixelShader b3 ポイントライトの数
	...
	rootParameter[10].DescriptorTable.pDescriptorRanges = descriptorWell;
	rootParameter[10].DescriptorTable.NumDescriptorRanges = _countof(descriptorWell);
	...
	// PSO生成成功のログ
	logFile_->Log("SUCCEEDED : SkinningModel Normal Subtract \n");
